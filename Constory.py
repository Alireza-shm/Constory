...
#Assigning topics to the topic numbers based on word frequency themes
topic_dict = {}
...
#create a dataframe from required elements
...
#Normalizing topics intensity and appearence in sentences by year
...
#plotng row 1 figures (Normalized individual topics by year = showing the discussed topics per year)
sns.set_style("white")
fs=18
start=0
#start=0 to show all words
